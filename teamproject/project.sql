...
-- (30, 'Inception', 'A thief, who steals corporate secrets through the use of dream-sharing technology, is given the inverse task of planting an idea into the mind of a CEO.', '2.99', 'action', 'dvd', 'PG-13', '30.jpg', 3),
-- (31, 'The Matrix', 'A computer hacker learns from mysterious rebels about the true nature of his reality and his role in the war against its controllers.', 34.99', 'action', 'bluray', 'R', '31.jpg', 3),
-- (32, 'Dangal', 'Former wrestler Mahavir Singh Phogat and his two wrestler daughters struggle towards glory at the Commonwealth Games in the face of societal oppression.', '14.99', 'action', 'bluray', 'R', '32.jpg', 3),
-- (33, 'Jumanji: Welcome to the Jungle', 'Four teenagers are sucked into a magical video game, and the only way they can escape is to work together to finish the game.', '18.99', 'comedy', 'bluray', 'PG-13', '33.jpg', 4),
-- (34, 'Ready Player One', 'When the creator of a virtual reality world called the OASIS dies, he releases a video in which he challenges all OASIS users to find his Easter Egg, which will give the finder his fortune.', '19.99', 'scifi', 'bluray', 'PG-13', '34.jpg', 1),
-- (35, 'Black Panther', 'T'Challa, the King of Wakanda, rises to the throne in the isolated, technologically advanced African nation, but his claim is challenged by a vengeful outsider who was a childhood victim of T'Challa's father's mistake.', '14.99', 'scifi', 'bluray', 'PG-13', '35.jpg', 1),
-- (36, 'Pacific Rim: Uprising', 'Jake Pentecost, son of Stacker Pentecost, reunites with Mako Mori to lead a new generation of Jaeger pilots, including rival Lambert and 15-year-old hacker Amara, against a new Kaiju threat.', '14.99', 'scifi', 'bluray', 'PG-13', '36.jpg', 1),
-- (37, 'I, Tonya', 'Competitive ice skater Tonya Harding rises amongst the ranks at the U.S. Figure Skating Championships, but her future in the activity is thrown into doubt when her ex-husband intervenes.', '19.95', 'sports', 'bluray', 'R', '37.jpg', 2),
-- (38, 'The Miracle Season', 'After the tragic death of star volleyball player Caroline "Line" Found, a team of dispirited high school girls must band together under the guidance of their tough-love coach in hopes of winning the state championship.', '13.99', 'sports', 'bluray', 'PG', '38.jpg', 2),
-- (39, 'Cars 3', 'Lightning McQueen sets out to prove to a new generation of racers that he's still the best race car in the world.'', '18.39', 'comedy', 'bluray','G', '39.jpg', 4),
-- (40, 'Cars', 'A hot-shot race-car named Lightning McQueen gets waylaid in Radiator Springs, where he finds the true meaning of friendship and family.', '19.93', 'comedy', 'dvd', 'G', '40.jpg', 4);

-- --------------------------------------------------------
-- (`Id`, `name`, `Description`, `price`, `category`, `Format`, `Rating`, `img`, `catId`)
--
